...
const String kTopicPidParams = 'flutter/pid_parameters'; // Тема для отправки PID-параметров
const String kTopicSetpoint = 'flutter/setpoint'; // Тема для отправки уставки температуры
        ...
        child: Column(
          ...
          children: [
            ...
            LinearProgressIndicator(
              value: currentTemp != null ? (currentTemp! - 10) / 25 : 0,
              backgroundColor: Colors.grey.shade200,
              valueColor: AlwaysStoppedAnimation<Color>(
                currentTemp != null && currentTemp! >= setpoint ? Colors.green : Colors.blue,
              ),
              minHeight: 6,
