        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                  child: _buildPidField(label: 'Proportional (P)', controller: pController),
                ),
                const SizedBox(width: 12),
                Expanded(
                  child: _buildPidField(label: 'Integral (I)', controller: iController),
                ),
                const SizedBox(width: 12),
                Expanded(
                  child: _buildPidField(label: 'Derivative (D)', controller: dController),
                ),
                const SizedBox(width: 16),
                ElevatedButton.icon(
                  onPressed: onSend,
